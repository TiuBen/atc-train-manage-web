...
function DetailStatisticsTable({dutyStatistics,teachStatistics}) {
    return (
        <>
            <table>
                <thead>
                ...
                <tbody>
                    <tr className="hover:bg-slate-400">
                        <td className="border border-slate-600 px-2 text-nowrap text-center"> 带班主任席</td>{" "}
                        <td className=" border border-slate-600 px-2 text-nowrap text-center">
                    ...
                    <tr className="hover:bg-slate-400">
                        <td className=" border border-slate-600 px-2 text-nowrap text-center">塔台管制席</td>
                        <td className=" border border-slate-600 px-2 text-nowrap text-center">
                    ...
                    <tr className="hover:bg-slate-400">
                        <td className=" border border-slate-600 px-2 text-nowrap text-center">塔台协调席</td>
                        <td className=" border border-slate-600 px-2 text-nowrap text-center">
                    ...
                    <tr className="hover:bg-slate-400">
                        <td className=" border border-slate-600 px-2 text-nowrap text-center">放行席</td>
                        <td className=" border border-slate-600 px-2 text-nowrap text-center">
                    ...
                    <tr className="hover:bg-slate-400">
                        <td className=" border border-slate-600 px-2 text-nowrap text-center">地面席</td>
                        <td className=" border border-slate-600 px-2 text-nowrap text-center">
                    ...
                    <tr className="hover:bg-slate-400">
                        <td className=" border border-slate-600 px-2 text-nowrap text-center">综合协调席</td>
                        <td className=" border border-slate-600 px-2 text-nowrap text-center">
                    ...
                    <tr className="hover:bg-slate-400">
                        <td className=" border border-slate-600 px-2 text-nowrap text-center">现场调度席</td>
                        <td className=" border border-slate-600 px-2 text-nowrap text-center">
                    ...
                    <tr className="hover:bg-slate-400">
                        <td className=" border border-slate-600 px-2 text-nowrap text-center">见习</td>
                        <td className=" border border-slate-600 px-2 text-nowrap text-center">
                    ...
                    <tr className="hover:bg-slate-400">
                        <td className=" border border-slate-600 px-2 text-nowrap text-center">教员</td>
                        <td className=" border border-slate-600 px-2 text-nowrap text-center">
                    ...
                    <tr className="hover:bg-slate-400">
                        <th className=" border border-slate-600 px-2 text-nowrap text-center" colSpan="5">
                            月度总小时统计
                        </th>
                    </tr>
                    <tr className="hover:bg-slate-400">
                        <th className=" border border-slate-600 px-2 text-nowrap text-center">统计</th>
                        <th className=" border border-slate-600 px-2 text-nowrap text-center">各席位总小时</th>
                        <th className=" border border-slate-600 px-2 text-nowrap text-center">白班小时</th>
                        <th className=" border border-slate-600 px-2 text-nowrap text-center">
                            夜班小时 <br /> (0000-0800)
                        </th>
                        <th className=" border border-slate-600 px-2 text-nowrap text-center">备注</th>
                    </tr>
                    <tr className="hover:bg-slate-400">
                        <td className=" border border-slate-600 px-2 text-nowrap text-center">席位</td>
                        <td className=" border border-slate-600 px-2 text-nowrap text-center">
                            {formatDecimal(
                    ...
                    <tr className="hover:bg-slate-400">
                        <td className=" border border-slate-600 px-2 text-nowrap text-center">现场调度</td>
                        <td className=" border border-slate-600 px-2 text-nowrap text-center">
                            {formatDecimal(dutyStatistics?.totalAOCTime?.time)}
                        </td>
                        <td className=" border border-slate-600 px-2 text-nowrap text-center">
                    ...
                    <tr className="hover:bg-slate-400">
                        <td className=" border border-slate-600 px-2 text-nowrap text-center">月度总小时</td>
                        <td className=" border border-slate-600 px-2 text-nowrap text-center">
